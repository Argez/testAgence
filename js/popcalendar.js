...
//	email :	fuushikaden@yahoo.com
	...
	var imgDir = "http://localhost:8080/prueba_dev/images/"			// directory for images ... e.g. var imgDir="/img/"
    ...
    */
	...
	{
		dayName = new Array	("Seg","Ter","Qua","Qui","Sex","Sab","Dom")
	}
   ...
   function WeekNbr(n) {
	...
	function popUpCalendar(ctl,	ctl2, format, alignment) {
		var	leftpos=0
		var	toppos=0
		...
		if (bPageLoaded)
		{
			if ( crossobj.visibility ==	"hidden" ) {
				...
				if (alignment == 'right')
				{
					// workaround para o problema do jscript fora dos limites da tela
